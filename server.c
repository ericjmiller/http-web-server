    ...
    while (true)
    {
        ...
        if (connected())
        {
            ...
            // this is the method
                if (i == 0) 
                {
                    printf("HTTP/1.1 200 OK '%s'", sp);
                    p34271ch = strstr(sp, "GET");
                    if ((pch-sp) == 0) 
                    {
                        printf("\n");
                    }
...
const char* lookup(const char* extension)
{
    ...
    if (extension != NULL)
    {
        if ((strcmp(extension, "css") || strcmp(extension, "CSS")) == 0)
        {
            return "text/css"; 
        }
        ...
        if ((strcmp(extension, "ico") || strcmp(extension, "ICO")) == 0)
        {
            return "image/x-icon"; 
        }
        ...
        if ((strcmp(extension, "js") || strcmp(extension, "JS")) == 0)
        {
            return "text/javascript"; 
        }
        if ((strcmp(extension, "png") || strcmp(extension, "PNG")) == 0)
        {
            return "image/png"; 
        }
